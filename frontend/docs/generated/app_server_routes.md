...
| --- | --- | --- | --- |
| `adas` | `app_server/api/adas_router.py` | 6 | [Open Domain Index](../app_server/domains/adas.md) |
...
| `ui_config` | `app_server/api/ui_config_router.py` | 2 | [Open Domain Index](../app_server/domains/ui_config.md) |
