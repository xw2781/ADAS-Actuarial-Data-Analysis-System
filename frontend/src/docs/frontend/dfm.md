...
- `DFM.html`: external scripts _none_; inline imports `/ui/DFM_main.js?v=20260129165558`, `/ui/dataset_main.js?v=2026022002`.
...
- [`DFM.html`](../../DFM.html) - DFM container page with tab slots.
- [`DFM_main.js`](../../DFM_main.js) - DFM bootstrapping and orchestrator loader.
- [`dfm_tabs_orchestrator.js`](../../dfm_tabs_orchestrator.js) - DFM tabs orchestration and message handling.
- [`dfm_details.js`](../../dfm_details.js) - Details tab logic and title syncing.
- [`dfm_ratios_tab.js`](../../dfm_ratios_tab.js) - Ratios tab calculations and controls.
- [`dfm_results_tab.js`](../../dfm_results_tab.js) - Results table rendering and pop-out actions.
- [`dfm_persistence.js`](../../dfm_persistence.js) - DFM template/pattern persistence.
<!-- AUTO-GEN:END -->
