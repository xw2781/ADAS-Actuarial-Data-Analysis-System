...
- `index.html`: external scripts `/ui/ui_shell.js?v=20260302`; inline imports _none_.
...
- [`index.html`](../../index.html) - Main desktop shell page and menu structure.
- [`ui_shell.js`](../../ui_shell.js) - Tab orchestration, iframe lifecycle, menus, and hotkeys.
...
- [`popout_bridge.js`](../../popout_bridge.js) - BroadcastChannel helper for pop-out tabs.
<!-- AUTO-GEN:END -->
