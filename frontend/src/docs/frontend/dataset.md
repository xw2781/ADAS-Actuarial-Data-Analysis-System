...
- `dataset_viewer.html`: external scripts _none_; inline imports `/ui/dataset_main.js?v=2026022002`, `/ui/dataset_shared.js`.
...
- [`dataset_viewer.html`](../../dataset_viewer.html) - Dataset page HTML entrypoint.
- [`dataset_main.js`](../../dataset_main.js) - Dataset grid, calculations, and API calls.
- [`dataset_shared.js`](../../dataset_shared.js) - Shared dataset markup helpers.
- [`dataset_shared.css`](../../dataset_shared.css) - Shared dataset/DFM visual styles.
- [`api.js`](../../api.js) - Client wrappers for dataset endpoints.
<!-- AUTO-GEN:END -->
