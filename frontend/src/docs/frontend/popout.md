...
- `popout_shell.html`: external scripts _none_; inline imports `./popout_bridge.js`.
...
- [`popout_shell.html`](../../popout_shell.html) - Secondary window shell hosting one iframe tab.
- [`popout_bridge.js`](../../popout_bridge.js) - BroadcastChannel connection between windows.
- [`ui_shell.js`](../../ui_shell.js) - Main-window pop-out/dock-back orchestration.
<!-- AUTO-GEN:END -->
