...
| --- | --- | --- | --- |
| `adas` | `backend/api/adas_router.py` | 6 | [Open Domain Index](../backend/domains/adas.md) |
| `app_control` | `backend/api/app_control_router.py` | 4 | [Open Domain Index](../backend/domains/app_control.md) |
| `audit_log` | `backend/api/audit_log_router.py` | 2 | [Open Domain Index](../backend/domains/audit_log.md) |
| `book` | `backend/api/book_router.py` | 3 | [Open Domain Index](../backend/domains/book.md) |
| `dataset` | `backend/api/dataset_router.py` | 6 | [Open Domain Index](../backend/domains/dataset.md) |
| `dataset_types` | `backend/api/dataset_types_router.py` | 3 | [Open Domain Index](../backend/domains/dataset_types.md) |
| `excel` | `backend/api/excel_router.py` | 5 | [Open Domain Index](../backend/domains/excel.md) |
| `field_mapping` | `backend/api/field_mapping_router.py` | 2 | [Open Domain Index](../backend/domains/field_mapping.md) |
| `project_book` | `backend/api/project_book_router.py` | 4 | [Open Domain Index](../backend/domains/project_book.md) |
| `project_settings` | `backend/api/project_settings_router.py` | 11 | [Open Domain Index](../backend/domains/project_settings.md) |
| `reserving_class` | `backend/api/reserving_class_router.py` | 11 | [Open Domain Index](../backend/domains/reserving_class.md) |
| `table_summary` | `backend/api/table_summary_router.py` | 2 | [Open Domain Index](../backend/domains/table_summary.md) |
| `ui_config` | `backend/api/ui_config_router.py` | 2 | [Open Domain Index](../backend/domains/ui_config.md) |
| `workflow` | `backend/api/workflow_router.py` | 5 | [Open Domain Index](../backend/domains/workflow.md) |
