...
import { setStorageInstance, loadNaBorders } from "./dfm_storage.js";
import {
  getDfmInst,
  resultsOnlyMode,
  ALLOWED_DFM_TABS,
...
} from "./dfm_ratios_tab.js";
import {
  renderResultsTable,
  wireResultsRatioBasisControls,
  wireResultsTabContextMenu,
  wireResultsTitlebar,
} from "./dfm_results_tab.js";
import { wireNotesInput } from "./dfm_notes_tab.js";
import {
...
import { scheduleRatioSelectionLoad, saveRatioSelectionPattern, saveDfmTemplate, loadDfmTemplate } from "./dfm_persistence.js";
import { wireRatioSyncChannel, requestRatioStateSync } from "./dfm_sync.js";
